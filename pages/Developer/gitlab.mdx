...
1. Clone the `/partnerhub/web{:bash}` repo.
...
To begin, you need to clone the `/partnerhub/web{:bash}` repo. From your terminal, run the following command:
...
3. Paste your copied key in the text box, it should look something like this: `47:xf:71:x7:02:1x:7x:x9:9x:x3:xx:7x:xx:6x:0x:xx{:bash}`.
